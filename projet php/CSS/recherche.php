<?php
	...
	require('connect.php');
		...
		if((!(isset($_POST['recherche']))))
		{
				...
				print('<input type="submit" name="envoyer" value="Validez"/>');
				print('</form>');
				...
				if(isset($_POST['envoyer']))
				{
					...
					$Resul = mysqli_query($db,'SELECT int_nom, int_prenom, int_email, int_telephone FROM intervenant INNER JOIN estcompetent ON comp_idintervenant = int_id;');
